...
export const SITE = {
  ...
  brand: "AI 公益站清单",
  // 搜索结果里中文标题大约 30 字截断，关键词往前放
  title: "AI 公益站清单 — Claude Code / Codex 免费额度实测",
  description:
    "实测可用的第三方 AI 公益站清单，含倍率、注册即得额度、邀请规则与须知。覆盖 Claude Opus 5、Opus 4.8 与 GPT-5.6，可用于 Claude Code 和 Codex。每条都标注实测日期。",
  keywords: [
    "AI 公益站",
    "AI 中转站",
    "Claude Code 中转站",
